...
public class tyoushihitsuji : MonoBehaviour {
	...
	private GameObject tyoshi_hitsuji;
	int tyoshi;
	public Text bairitu;
	void Start () {
		...
		if (var == 3) {
			...
			tyoshi_hitsuji=GameObject.Find ("tyoshiput");
			tyoshi_hitsuji.GetComponent<tyoshiput> ().hitsuji=var;
		}
